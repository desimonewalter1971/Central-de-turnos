...
urlpatterns = [
    ...
    #
    path('medicos/', views.medicoForm,name='medico'),    
    ...
    #
    path('pacientes/', views.pacienteForm,name='pacientes'),
    ...
    #
    path('agenda/', views.agendaForm,name='agenda'),
    ...
    #
    path('turnos/', views.turnoForm,name='turno'),
